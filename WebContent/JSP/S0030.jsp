	...
	<form action="S0031.html" method="POST" name="registerAccount">
		...
		<table class="tablePosition" >
			...
			<tr>
				...
				<td>
					<input type="password" name="passwordCheck" size="40" placeholder="パスワード（確認）" required />
				</td>
			</tr>
			<tr>
				<td align="right">
				...
				<td>
					<label><input type="radio" name="authSales" value="0" required />権限なし</label>
					<label><input type="radio" name="authSales" value="1" required />権限あり</label>
				</td>
			</tr>
			<tr>
				<td align="right">
				...
				<td>
					<label><input type="radio" name="authAccount" value="0" required />権限なし</label>
					<label><input type="radio" name="authAccount" value="1" required />権限あり</label>
				</td>
			</tr>
		</table>
